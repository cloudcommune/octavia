...
ADD_ECMP_ROUTES_FLOW = 'octavia-add-ecmp-routes-flow'
...
CREATE_MULTI_LOADBALANCER_FLOW = 'octavia-create-multi_loadbalancer-flow'
...
DEL_ECMP_ROUTES_FLOW = 'octavia-del-ecmp-routes-flow'
...
SCALE_LOADBALANCER_FLOW = 'octavia-scale-loadbalancer-flow'
...
BATCH_UPDATE_L7POLICY_FLOW = 'octavia-batch-update-l7policy-flow'
...
MARK_AMP_MULTI_INDB = 'octavia-mark-amp-multi-indb'
AMP_SETVIP_SUBFLOW = 'octavia-setvip-subflow'
GET_SETVIP_SUBFLOW = 'octavia-get-setvip-subflow'
...
AMP_POST_LOOP_VIP_PLUG = 'octavia-amp-post-loop-vip-plug'
...
ECMP_DELETE = 'ecmp-delete'
ECMP_ADD = 'ecmp-add'
GET_AMPHORA_FOR_ECMP_ADD = 'get-amphora-for-ecmp-add'
...
TOPOLOGY_MULTI_ACTIVE = 'MULTI_ACTIVE'
ROLE_MASTER = 'MASTER'
ROLE_BACKUP = 'BACKUP'
ROLE_MULTI = 'MULTI'
ROLE_STANDALONE = 'STANDALONE'
# multi active
SUPPORTED_LB_TOPOLOGIES = (TOPOLOGY_MULTI_ACTIVE, TOPOLOGY_ACTIVE_STANDBY,
                           TOPOLOGY_SINGLE)
...
MULTI_ACTIVE_NUM = 'multi_active_num'
